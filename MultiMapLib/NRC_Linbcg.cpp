...
MULTIMAP_API NRC_Linbcg::~NRC_Linbcg(void) {
}
MULTIMAP_API NRC_Linbcg::NRC_Linbcg(void) {
}

MULTIMAP_API void NRC_Linbcg::solve(VecDoub_I &b, VecDoub_IO &x, const Int itol, const Doub tol, const Int itmax, Int &iter, Doub &err)
{
...
Doub NRC_Linbcg::snrm(VecDoub_I &sx, const Int itol)
{
